    ...
    private fun sourceRow(source: BookSource): View {
        ...
        actions.addView(Button(this).apply {
            ...
            setOnLongClickListener {
                android.app.AlertDialog.Builder(this@SourceManagerActivity)
                    .setTitle("确认删除")
                    .setMessage("确定要删除书源「${source.bookSourceName.ifBlank { source.bookSourceUrl }}」吗？")
                    .setPositiveButton("删除") { _, _ ->
                        dataSource.deleteSource(source.bookSourceUrl)
                        refreshSources()
                        toast("已删除 ${source.bookSourceName.ifBlank { source.bookSourceUrl }}")
                    }
